...
function Business() {
	...
	return (
		<div className="site-wrapper-reveal section-space--pt_100">
						...
						<div className="col-lg-12">
							<div className="section-title-wrap text-center">
								<h3 className="heading">
									...
									<span className="text-color-primary">Businesses</span>
								</h3>
							</div>
						</div>
					</div>
							...
							<div className="feature-images__four">
								<div className="row">
									{businessSolutions.map((solution, index) => {
										...
										return (
											<div
												className="single-item col-lg-4 col-md-6 mt-30 wow move-up animated"
												key={index}
											>
