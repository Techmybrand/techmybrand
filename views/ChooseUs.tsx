							...
							<div className="col-lg-12">
								<div className="section-title-wrap text-center section-space--mb_30">
									...
									<p className="title-dec-text">
										The IT services that TechMyBrand are running can
										be segmented by the type of skills employed to
										deliver the service (design, build, run).
										Technically, these fall into three main
										categories: business process services, application
							...
							<div className="row">
								<div className="col-12">
									...
									<div className="section-under-heading text-center section-space--mt_40">
										...
										<Link href="#">Take the challenge!</Link>
									</div>
								</div>
							</div>
						</div>
